...
#define WEBRTC_CHANNEL_PUBLISH      (getenv("WEBRTC_CHANNEL_PUBLISH")==NULL?"movie-only":getenv("WEBRTC_CHANNEL_PUBLISH"))
#define WEBRTC_METADATA             (getenv("WEBRTC_METADATA")==NULL?"\"metadata\":{\"access_token\":\"xxxx\",\"stats\":false}":getenv("WEBRTC_METADATA"))
#define MOVIE_FILE                  (getenv("MOVIE_FILE")==NULL?"test.mov":getenv("MOVIE_FILE"))
